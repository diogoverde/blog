        ...
        <div className="pt-0 font-medium lg:pt-0 flex">
          <div className="mr-2 cursor-pointer" onClick={() => setParty(!party)}>
            <svg
              ...
              viewBox="0 0 122 122"
              className="h-6 w-6 ml-auto mt-1 fill-current text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400 dark:text-gray-200"
            >
              <g>
          ...
          <a href="https://twitter.com/diogo__verde" className="mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 ml-auto mt-1 fill-current text-gray-500 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 "
              viewBox="0 0 24 24"
            >
