        ...
        <div className="pt-0 font-medium lg:pt-0 flex">
          <a href="https://twitter.com/diogo__verde" className="mr-2">
            <svg
              ...
              className="h-6 w-6 ml-auto mt-1 fill-current text-gray-500 hover:text-blue-600"
              viewBox="0 0 24 24"
            >
          ...
          <a href="https://github.com/diogoverde">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 ml-auto mt-1 fill-current text-gray-500 hover:text-gray-900 "
              viewBox="0 0 24 24"
            >
